...
| e005b | swa_mask_ablation_v2 | RQ3 | SWA mask → ΔNLL > 0 at pos > 4096 (one-sample t, d_z ≥ 0.5) | PRE-REGISTERED 2026-04-27 | VALIDATED | 2026-04-27 | 2× A100 80GB PCIe | [PLAN](experiments/e005b_swa_mask_ablation_v2/PLAN.md) | [ANALYSIS](experiments/e005b_swa_mask_ablation_v2/ANALYSIS.md) | [stats.json](outputs/e005b_swa_mask_ablation_v2/stats.json) |
| e007b | long_context_sparse_hook | RQ3 | Global attn distance diverges from SWA at lengths ≥ 4096 (sparse QK hook) | PRE-REGISTERED 2026-04-27 | FAILED | 2026-04-27 | 2× A100 80GB PCIe | [PLAN](experiments/e007b_long_context_sparse_hook/PLAN.md) | [ANALYSIS](experiments/e007b_long_context_sparse_hook/ANALYSIS.md) | [stats.json](outputs/e007b_long_context_sparse_hook/stats.json) |
...
*Last updated: 2026-04-27 (session 5) — **H3_alt SUPPORTED**: e005b VALIDATED + e006b VALIDATED (2/3); e007b FAILED (direction reversed — auto_validate direction fix applied); e008 PENDING*
